    ...
    def optimize(
        ...
        if auto_cleanup:
            ...
            current_graph_def = self.final_prune(
                current_graph_def, pass_name, protected_set
            )
...
class PatternMatcher:
    ...
    def match_once(
                        ...
                        if result.replaced_nodes:
                            ...
                            if nodes_with_ext_consumers:
                                ...
                                safe_to_replace = [
                                    ...
                                    if name
                                    not in [n for n, _ in nodes_with_ext_consumers]
                                ]
        ...
        # Apply node mappings and hoisted controls
        if global_node_mapping or hoisted_controls_map:
            logging.debug(
            ...
            for node in new_nodes:
                # Find if any input of this node was remapped from a node with hoisted controls
                node_hoisted = set()
...
class BasePass:
    ...
    def make_node_name(self, root_node_name, op_type, suffix=""):
        ...
        for i, part in enumerate(parts):
            ...
            if "_" in part and (part.endswith("_pass")):
